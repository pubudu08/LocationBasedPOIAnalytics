	...
	<div id="contentWrapper">
			...
			<div class="inside-nav">
				...
				<ul class="nav-a">
					<li><a href="${pageContext.request.contextPath}/login"
						class="">Login</a></li>
					<li>|</li>
					<li><a class="selected" href="#">Register</a></li>
				</ul>
			</div>
		</div>
		...
		<div class="mc-a">
			<c:if test="${not empty param.errorMsg}">
				...
				<div class="errorblock">${param.errorMsg}</div>
			</c:if>
			<div class="signing-form">
				<form action="${pageContext.request.contextPath}/signup"
					class="new_user" method="post" id="signupForm">
					<div>
					...
					<div>
						<label>Password</label> <input class="textbox-a" id="password"
							name="password" placeholder="Password" size="30" type="password"
							required="required">
					</div>
					<div>
						<label>Email</label> <input class="textbox-a" id="email"
							name="email" placeholder="email" size="30" type="email"
							required="required">
					</div>
					<div>
