	...
	public static void main(String[] args) {
		try {
			...
			GeoQuery query = new GeoQuery(new GeoLocation(
					Double.parseDouble("6.933208392659332"), Double.parseDouble("79.84366048810165")));
			ResponseList<Place> places = twitter.reverseGeoCode(query);
			if (places.size() == 0) {
				System.out
						.println("No location associated with the specified lat/lang");
			} else {
